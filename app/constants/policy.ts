...
export const skipToContentPolicy = {
  skipLinkClassName:
    "sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:rounded-md focus:bg-backgroundPage focus:px-4 focus:py-2 focus:text-accentPrimary focus:font-medium focus:shadow-md focus:outline-none focus:ring-2 focus:ring-accentPrimary",
} as const;
