...
/** Accessibility skip-to-content hidden link configuration. */
export const skipToContentPolicy = {
  linkClassName:
    "sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-50 focus:rounded-md focus:bg-backgroundPage focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:text-textPrimary focus:shadow-md focus:ring-2 focus:ring-accentPrimary focus:outline-none",
} as const;
