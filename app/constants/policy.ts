...
export const skipToContentPolicy = {
  skipLinkClassName:
    "sr-only focus:not-sr-only focus:absolute focus:z-50 focus:p-4 focus:bg-backgroundPage focus:text-textPrimary focus:outline-none focus-visible:ring-2 focus-visible:ring-accentPrimary",
} as const;
