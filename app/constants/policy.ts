/** Accessibility policy for hidden-until-focused elements. */
export const skipToContentPolicy = {
  linkClassName:
    "sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-50 focus:rounded-md focus:bg-surfaceElevated focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:text-textPrimary focus:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-accentPrimary",
} as const;
