...
/** Screen-reader friendly skip link for keyboard navigation bypassing the global header. */
export const skipToContentPolicy = {
  linkClassName:
    "sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:rounded-md focus:bg-surfaceElevated focus:px-4 focus:py-2 focus:text-sm focus:font-semibold focus:text-textPrimary focus:shadow-md focus:outline-none focus:ring-2 focus:ring-accentPrimary",
} as const;
