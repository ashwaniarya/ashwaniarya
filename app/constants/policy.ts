...
/** Accessibility: Visually hidden until focused to bypass the sticky header. */
export const skipToContentPolicy = {
  skipLinkClassName:
    "sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-50 focus:rounded-sm focus:bg-backgroundPage focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:text-accentPrimary focus:shadow-md focus:outline-none focus:ring-2 focus:ring-accentPrimary focus:ring-offset-2 focus:ring-offset-backgroundPage",
} as const;
