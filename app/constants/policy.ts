...
/** Skip-to-content link: visually hidden until focused, ensuring keyboard accessibility over sticky header. */
export const skipToContentPolicy = {
  linkClassName: "sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:rounded-sm focus:bg-backgroundPage focus:px-4 focus:py-2 focus:text-sm focus:font-semibold focus:text-accentPrimary focus:outline-none focus:ring-2 focus:ring-accentPrimary focus:ring-offset-2 focus:ring-offset-backgroundPage focus:shadow-md",
} as const;
