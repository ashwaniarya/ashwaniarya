...
export const skipToContentPolicy = {
  linkClassName:
    "sr-only focus:not-sr-only focus:absolute focus:z-50 focus:p-4 focus:bg-backgroundPage focus:text-accentPrimary focus:outline-none focus:ring-2 focus:ring-accentPrimary",
} as const;
